...
- Soluções em TypeScript, Python e Java
- Otimização de tarefas repetitivas e operacionais

## 📌 Sobre mim

Sou uma profissional em transição para a área de tecnologia, com interesse em construir soluções úteis, escaláveis e com impacto real. Tenho me dedicado a aprender e aplicar boas práticas de desenvolvimento, além de explorar automações que tornam processos mais eficientes e inteligentes.
...
> 🌱 Sempre aprendendo, construindo e automatizando com propósito.
